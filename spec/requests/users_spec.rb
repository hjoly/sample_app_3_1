  ...
  describe "follow/unfollow a user" do
    ...
    describe "failure:" do
      it "should not be able to follow/unfollow himself" do
        ...
        response.should_not have_selector("input", :name => "commit", :value => "Follow")
        response.should_not have_selector("input", :name => "commit", :value => "Unfollow")
      end

      it "should not be able to follow a user already followed" do
        click_link "Followed User"
        response.should_not have_selector("input", :name => "commit", :value => "Follow")
      end

      it "should not be able to unfollow a user who is not followed yet" do
        click_link "Not Followed User"
        response.should_not have_selector("input", :name => "commit", :value => "Unfollow")
      end
    end
    ...
    describe "success:" do
      it "should follow another user who is not followed yet" do
        click_link "Not Followed User"
        response.should have_selector("input", :name => "commit", :value => "Follow")
      end

      it "should unfollow another user already followed" do
        click_link "Followed User"
        response.should have_selector("input", :name => "commit", :value => "Unfollow")
      end
    end
  end
